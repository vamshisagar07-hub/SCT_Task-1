...
* `SCT task 1.twbx`: Packaged Tableau workbook
* `SCT visualization tableau task 1_page-0001.jpg`: Exported visualization image
* `SCT visualization tableau task 1`: Exported Workbook pdf
